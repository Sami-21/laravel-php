    ...
    <template v-slot:top>
      <v-toolbar flat>
        ...
        <v-dialog v-model="AddSuccess" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Product Added Successfully</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
        ...
        <v-dialog v-model="EditSuccess" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Product Edited Successfully</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
        ...
        <v-dialog v-model="DeleteSuccess" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Product Deleted Successfully</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
