<template>
  <v-data-table :headers="headers" :items="transaction" sort-by="name" class="elevation-1">
    <template v-slot:top>
      <v-toolbar flat>
        <v-toolbar-title>Transaction</v-toolbar-title>
        <v-divider class="mx-4" inset vertical></v-divider>
        <v-autocomplete clearable :items="transaction.map(item => { return item.client})"></v-autocomplete>
        <v-spacer></v-spacer>
        ...
        <v-dialog v-model="AddSuccess" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Transaction Added Successfully</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
        ...
        <v-dialog v-model="EditSuccess" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Transaction Edited Successfully</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
        ...
        <v-dialog v-model="DeleteSuccess" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Transaction Deleted Successfully</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
